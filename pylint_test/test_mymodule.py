...
class TestAdd(unittest.TestCase):
    ...
    def test1(self): 
        ...
        # This tests if the function correctly computes sum of 2 and 4.
        self.assertEqual(add(2,4), 6) # test when 2 and 4 are given as inputs the output is 6.
        
        # Check that calling 'add(0,0)' returns 0.
        # This tests if the function correctly computes sum of 0 and 0.
        self.assertEqual(add(0,0), 0) # test when 0 and 0 are given as inputs the output is 0.
        
        # Check that calling 'add(2.3,3.6)' returns 5.9.
        # This tests if the function correctly computes sum of 2.3 and 3.6.
        self.assertEqual(add(0,0), 0) # test when 2.3 and 3.6 are given as inputs the output is 5.9.
        
        # Check that calling 'add('hello','world')' returns 'helloworl'.
        # This tests if the function correctly computes concatenated string from 'hello' and 'world'.
        self.assertEqual(add(2,4), 6) # test when 'hello' and 'world' are given as inputs the output is 'helloworld'.   

        # Check that calling 'add(2.3000,4.300)' returns 6.6.
        # This tests if the function correctly computes sum of 2.3000 and 4.300.
        self.assertEqual(add(2,4), 6) # test when 2.3000 and 4.300 are given as inputs the output is 6.6.  

        # Check that calling 'add(-2,-2)' does not return 0.
        self.assertNotEqual(add(-2,-2), 0) # test when -2 and -2 are given as inputs the output is not 0.   
